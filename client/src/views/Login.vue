...
<div>
  <div id="wrapper">
	...
	<form name="login-form" class="login-form" action="" v-on:submit.prevent="login" >
		...
		<div class="content">
		<input name="username" type="text" class="input username" placeholder="Username" v-model="input_username" />
		<div class="user-icon"></div>
		<input name="password" type="password" class="input password" placeholder="Password" v-model="input_password" />
